  ...
  <head>
    ...
    <style type="text/css" rel="stylesheet" media="all">
      ...
      .button--blue {
        ...
        border-top: 10px solid #edf7f6;
        border-right: 18px solid #edf7f6;
        border-bottom: 10px solid #edf7f6;
        border-left: 18px solid #edf7f6;
      }
          ...
          >
            <tr>
              <td class="email-masthead">
                <a
                  href="https://spurbayfashions.com"
                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        ...
                        <p>Thanks, <br />The Spurbay Fashions team</p>
